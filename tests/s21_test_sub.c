...
END_TEST  //  подаем  -10 -(-10) = 0 функция выводит 20
...
END_TEST  //  подаем  10 -20 = -10 функция выводит 30
...
START_TEST(sub_test_5) {
    s21_decimal a = {{100000000, 0, 0, 0}};  // ***
    s21_decimal b = {{200, 0, 0, 0}};
    s21_decimal res = {{0, 0, 0, 0}};
    s21_decimal* p_res = &res;
    s21_sub(a, b, &res);
    s21_decimal c = {{99999800, 0, 0, 0}};
    ck_assert_int_eq(c.bits[3], res.bits[3]);
    ck_assert_int_eq(c.bits[2], res.bits[2]);
    ck_assert_int_eq(c.bits[1], res.bits[1]);
    ck_assert_int_eq(c.bits[0], res.bits[0]);
...
START_TEST(s21_subTest16) {
    ...
    set_scale(&origin, 14);
    // 
    // s21_decimal* p_src2 = &src2;
    // s21_decimal* p_src3 = &origin;
    ck_assert_int_eq(origin.bits[3], result.bits[3]);
    ck_assert_int_eq(origin.bits[2], result.bits[2]);
    ck_assert_int_eq(origin.bits[1], result.bits[1]);
    ck_assert_int_eq(origin.bits[0], result.bits[0]);
...
END_TEST
// 1000000000001100 0000000000000000
...
START_TEST(s21_subTest21) {
    ...
    origin.bits[1] = 0b10100111010011100111001000100001;
    origin.bits[2] = 0b00011100010100111001110111101101;
    origin.bits[3] = 0b00000000000100010000000000000000; //17
    // 87666669134,97530891357775295
    // show_bit(result);
    ck_assert_int_eq(origin.bits[3], result.bits[3]);
    ck_assert_int_eq(origin.bits[2], result.bits[2]);
    ck_assert_int_eq(origin.bits[1], result.bits[1]);
...
START_TEST(s21_test_decimal_sub_0) {
...
START_TEST(s21_test_decimal_sub_1) {
...
START_TEST(s21_test_decimal_sub_2) {
...
START_TEST(s21_test_decimal_sub_3) {
...
START_TEST(s21_test_decimal_sub_7) {
...
START_TEST(s21_test_decimal_sub_8) {
...
START_TEST(s21_test_decimal_sub_10) {
    s21_decimal c = {{100, 0, 0, 0}};
...
START_TEST(s21_test_decimal_sub_11) {
...
START_TEST(uytre) {
    ...
    src2.bits[3] = 0b00000000000110000000000000000000;
    s21_decimal result = {{0, 0, 0, 0}};
    int tre = is_greater(src1, src2);
    ck_assert_int_eq(tre, 0);
}
END_TEST
