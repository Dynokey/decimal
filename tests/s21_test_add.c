...
START_TEST(add_13) {
    s21_decimal val1 = {{U_MAX_INT, U_MAX_INT, U_MAX_INT, 0}};
    s21_decimal val2 = {{4, 0, 0, ~(U_MAX_INT / 2)}};
    s21_decimal res = {0};
...
//     s21_decimal src1 = {{U_MAX_INT, U_MAX_INT, U_MAX_INT, 0}};
//     s21_decimal src2 = {0};
//     float a = 0.01448;
...
//     s21_decimal src1 = {{U_MAX_INT, U_MAX_INT, U_MAX_INT, ~(INT_MAX)}};
//     s21_decimal src2 = {0};
//     float a = -0.01448;
//     s21_from_float_to_decimal(a, &src2);
//     s21_decimal res_dec = {0};
...
START_TEST(add_0) {
    s21_decimal val1 = {{15, 0, 0, ~(U_MAX_INT / 2)}};
...
START_TEST(add_1) {
    ...
    s21_decimal val2 = {{15, 0, 0, ~(U_MAX_INT / 2)}};
    s21_decimal res = {0};
    ck_assert_int_eq(0, s21_add(val1, val2, &res));
}
END_TEST
...
START_TEST(add_3) {
    s21_decimal val1 = {
        {U_MAX_INT, U_MAX_INT, U_MAX_INT, ~(U_MAX_INT / 2)}};
    s21_decimal val2 = {{2, 0, 0, ~(U_MAX_INT / 2)}};
    s21_decimal res = {0};
...
START_TEST(add_6) {
    s21_decimal val1 = {{8, 0, 0, ~(U_MAX_INT / 2)}};
    s21_decimal val2 = {{2, 0, 0, 0}};
    s21_decimal res = {0};
    ck_assert_int_eq(0, s21_add(val1, val2, &res));
}
...
START_TEST(add_7) {
    s21_decimal val1 = {{2, 0, 0, ~(U_MAX_INT / 2)}};
    s21_decimal val2 = {{8, 0, 0, 0}};
    s21_decimal res = {0};
    ck_assert_int_eq(0, s21_add(val1, val2, &res));
}
...
START_TEST(add_9) {
    ...
    s21_decimal val2 = {{8, 0, 0, ~(U_MAX_INT / 2)}};
    s21_decimal res = {0};
    ck_assert_int_eq(0, s21_add(val1, val2, &res));
}
END_TEST
...
START_TEST(add_15) {
    s21_decimal val1 = {{4, 0, 0, ~(U_MAX_INT / 2)}};
    s21_decimal val2 = {{U_MAX_INT, U_MAX_INT, U_MAX_INT, 0}};
    s21_decimal res = {0};
    ck_assert_int_eq(0, s21_add(val1, val2, &res));
}
END_TEST
...
START_TEST(s21_test_decimal_add_11) {
    s21_decimal c = {{0, U_MAX_INT - 1, 0, 0}};
    s21_decimal d = {{0, 1, 0, 0}};
    s21_decimal etalon = {{0, U_MAX_INT, 0, 0}};
...
START_TEST(s21_test_decimal_add_12) {
    s21_decimal c = {{0, 0, U_MAX_INT - 1, 0}};
    s21_decimal d = {{0, 0, 1, 0}};
    s21_decimal etalon = {{0, 0, U_MAX_INT, 0}};
...
START_TEST(s21_test_decimal_add_17) { //sub
    s21_decimal a = {{10, 0, 0, MINUS}};
    s21_decimal b = {{0, 0, 0, 0}};
    s21_decimal res = {{0, 0, 0, 0}};
    s21_decimal* p_res = &res;
    s21_add(a, b, &res);
    s21_decimal c = {{10, 0, 0, MINUS}};
    ck_assert_int_eq(c.bits[3], res.bits[3]);
    ck_assert_int_eq(c.bits[2], res.bits[2]);
    ck_assert_int_eq(c.bits[1], res.bits[1]);
    ck_assert_int_eq(c.bits[0], res.bits[0]);
...
START_TEST(s21_test_decimal_add_18) {  // sub
    s21_decimal a = {{10, 0, 0, MINUS}};
    s21_decimal b = {{10, 0, 0, MINUS}};
    s21_decimal res = {{0, 0, 0, 0}};
    s21_decimal* p_res = &res;
    s21_add(a, b, &res);
    s21_decimal c = {{20, 0, 0, MINUS}};
    ck_assert_int_eq(c.bits[3], res.bits[3]);
    ck_assert_int_eq(c.bits[2], res.bits[2]);
    ck_assert_int_eq(c.bits[1], res.bits[1]);
    ck_assert_int_eq(c.bits[0], res.bits[0]);
...
START_TEST(s21_test_decimal_add_19) {  // sub
    s21_decimal a = {{UINT32_MAX, 0, 0, 0}};
    s21_decimal b = {{1, 0, 0, 0}};
    s21_decimal res = {{0, 0, 0, 0}};
    s21_decimal* p_res = &res;
    s21_add(a, b, &res);
    s21_decimal c = {{0, 1, 0, 0}};
    ck_assert_int_eq(c.bits[3], res.bits[3]);
    ck_assert_int_eq(c.bits[2], res.bits[2]);
    ck_assert_int_eq(c.bits[1], res.bits[1]);
    ck_assert_int_eq(c.bits[0], res.bits[0]);
...
START_TEST(s21_test_decimal_add_20) {  // sub
    s21_decimal c = {0};
...
START_TEST(s21_test_decimal_add_27) {
    s21_decimal c = {{U_MAX_INT, U_MAX_INT, 0, 0}};
    s21_decimal d = {{0b00000000000000000000000000000001, 0, 0, 0}};
...
START_TEST(s21_test_decimal_add_28) {  // *** 10110000001111100111110100001001 01101011000000011011001011110010 10010111001101000101101011101101
    s21_decimal src1 = {{0}};
    ...
    original_res.bits[0] = 0b10010111001101000101101011101101;
    original_res.bits[1] = 0b01101011000000011011001011110010;
    original_res.bits[2] = 0b10110000001111100111110100001001;
    original_res.bits[3] = 0b10000000000100000000000000000000; //16
...
// - 5454545124545, 4535265454545645 + 54564654 = -5454490559891.4535265454545645 = 10110000001111100111110100001001 01101011000000011011001011110010 10010111001101000101101011101101
//  10110000001111100111110100001001 01101011000000011011001011110010 10010111001101000101101011101101 
// s21_decimal c = 101100000011111011110000100101001111100111101000001001011010110110000010111000100101101011101101->54545451245454535265454545645 {
//     10000010111000100101101011101101,
//         11111001111010000010010110101101,
//         10110000001111101111000010010100,
//         10000000000011100000000000000000
// }
// }
// ;
// s21_decimal d = {{00000011010000001001011100101110, 0, 0, 0}};
// s21_decimal etalon = {
//     {01110001001010101101101011101101, 00101110001111001110000111111000,
//      10110000001111101110111101101101, 10000000000011100000000000000000}};
...
START_TEST(s21_test_decimal_add_simple_1) {  // sub
...
START_TEST(s21_test_decimal_add_simple_2) {  // sub
    ...
    s21_decimal* p_res = &res;
    s21_add(a, b, p_res);
    s21_decimal c1 = {{0b11111111111111111111111111111110, 0b00000000000000000000000000000000, 0b1, 0}};
...
END_TEST
// s21_decimal res = {{0b11111111111111111111111111111110, 0, 1, 0}};
// 11111111111111111111111111111110 00000000000000000000000000000000 00000000000000000000000000000001 00000000000000000000000000000000
